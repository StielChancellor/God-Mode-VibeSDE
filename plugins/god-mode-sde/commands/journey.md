...
2. Delegate to the **ux-journey-designer** subagent **at the frontier (highest) model**, driven by the **journey-mapping** skill. Map the complete flow — **frontend AND backend UI/UX** — every screen, state, transition, and the backend touchpoints behind them.
