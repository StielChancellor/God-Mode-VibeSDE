---
description: Architecture gate — solution-architect + security-engineer review the blueprint, ADRs, and threat model BEFORE any code.
---
...
2. Dispatch two reviewers in parallel:
   ...
   - **security-engineer** — review the **threat model** (via `secure-coding`): trust boundaries, authn/authz, data classification, secrets handling, injection sinks, dependency risk, encryption in transit/at rest, secure defaults (OWASP).
